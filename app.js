...
let t = d.getHours();
if (t > 12) {
  document.getElementById("show1").innerText = `Time is:${
    t - 12
  } PM ${d.getMinutes()} Minutes ${d.getSeconds()}    Seconds`;
} else {
  document.getElementById(
    "show1"
  ).innerText = `Time is:${t} AM ${d.getMinutes()} Minutes ${d.getSeconds()}    Seconds`;
}
// document.write("<br>");
document.getElementById(
  "date"
).innerText = `${d.getMonth()}-${d.getDay()}-${d.getFullYear()}`;
// 5, 6, 7
//Task # 3
var a = 5;
var b = 6;
...
if ((0 == year % 4 && 0 != year % 100) || 0 == year % 400) {
  ...
  document.getElementById("leapYear").innerText =
    "Current Year is not Leap Year";
}
...
document.getElementById("task14").innerText = capital_letter(
...
document.getElementById("16a").innerText = reverse3([5, 4, 3]);
document.getElementById("16b").innerText = reverse3([1, 0, -1]);
document.getElementById("16c").innerText = reverse3([2, 3, 1]);
...
document.getElementById("18a").innerText = Kth_greatest_in_array(
  [1, 2, 6, 4, 5],
  3
);
document.getElementById("18b").innerText = Kth_greatest_in_array(
  [-10, -25, -47, -36, 0],
  1
);
...
document.getElementById("19a").innerText = array_element_mode([
  1, 2, 3, 2, 2, 8, 1, 9,
]);
...
document.getElementById("20a").innerText = `Original Array ${num}`;
document.getElementById("20b").innerText = array_element_replace(num, 2, 5);
